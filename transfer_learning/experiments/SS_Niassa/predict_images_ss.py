...
def predict_images():
    ...
    model_cfg_jsons = ['/host/data_hdd/save/ss/' +
                       'ss_species_51_201708072308_cfg.json',
                       '/host/data_hdd/save/ss/' +
                       'ss_blank_vs_non_blank_small_201707172207_cfg.json']
    ...
    out_file_names = ['predictions_species_ss.csv', 'predictions_blank_ss.csv']
