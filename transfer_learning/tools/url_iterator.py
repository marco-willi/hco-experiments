...
class URLIterator(Iterator):
    """Iterator capable of reading images from a list of urls.
    # Arguments
        urls: a list of urls
        labels: a list of class labels corresponding to the urls
    ...
    def __init__(self, urls, labels, classes, image_data_generator,
