...
This report shows results obtained from training and evaluating a convolutional neural network (CNN) using images from `r params$project_name`. The goal is to automatically identify animal species in camera-trap images. 
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=width_small, fig.width=width_small, dpi=56, out.width="450px", out.height="450px"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=width_small, fig.width=width_small, dpi=56, out.width="450px", out.height="450px"}
# ```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=width_small, fig.width=width_small, optipng=''}
############################ -
